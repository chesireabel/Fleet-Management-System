  ...
  "node_modules/core-js/modules/es.data-view.set-float16.js"() {
    ...
    var packFloat16 = function(value) {
      if (value !== value)
        return 32256;
      if (value === 0)
        return (1 / value === -Infinity) << 15;
      var neg = value < 0;
      if (neg)
        value = -value;
      if (value >= MIN_INFINITY16)
        return neg << 15 | 31744;
      if (value < MIN_NORMAL16)
        return neg << 15 | roundTiesToEven(value * REC_MIN_SUBNORMAL16);
  ...
  "node_modules/core-js/modules/esnext.math.clamp.js"() {
    ...
    $({ target: "Math", stat: true, forced: true }, {
      clamp: function clamp(value, min, max) {
        ...
        notANaN(aNumber(min));
        notANaN(aNumber(max));
        if (sameValue(min, 0) && sameValue(max, -0) || min > max)
          throw new $RangeError("`min` should be smaller than `max`");
